...
This website uses partials and JavaScript to load content, so it must be served on a local server.

Steps:

1. Download the project by clicking the **green "Code" button** at the top of this repository and then **"Download ZIP"**.  
...
7. Your site will open in the browser at http://127.0.0.1:5500/ (or similar).  
